module attributes {llzk.lang = "haloumi"} {
  ...
  struct.def @"outer group" {
    ...
    function.def @constrain(%arg0: !struct.type<@"outer group"<[]>>, %arg1: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %2 = struct.readm %0[@out_0] : <@"inner group"<[]>>, !felt.type
      constrain.eq %1, %2 : !felt.type, !felt.type
      %3 = struct.readm %arg0[@adv_0_5] : <@"outer group"<[]>>, !felt.type
      %4 = felt.neg %3 : !felt.type
      %5 = struct.readm %arg0[@adv_1_5] : <@"outer group"<[]>>, !felt.type
      constrain.eq %4, %5 : !felt.type, !felt.type
      %6 = felt.mul %3, %5 : !felt.type, !felt.type
      %7 = struct.readm %arg0[@out_0] : <@"outer group"<[]>>, !felt.type
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      function.call @"test group1"::@constrain(%7, %5) : (!struct.type<@"test group1"<[]>>, !felt.type) -> ()
      %8 = struct.readm %arg0[@adv_2_3] : <@Main<[]>>, !felt.type
      %9 = struct.readm %7[@out_0] : <@"test group1"<[]>>, !felt.type
      constrain.eq %8, %9 : !felt.type, !felt.type
      %10 = struct.readm %arg0[@"outer group_3"] : <@Main<[]>>, !struct.type<@"outer group"<[]>>
      function.call @"outer group"::@constrain(%10, %8) : (!struct.type<@"outer group"<[]>>, !felt.type) -> ()
      %11 = struct.readm %arg0[@adv_2_5] : <@Main<[]>>, !felt.type
      %12 = struct.readm %10[@out_0] : <@"outer group"<[]>>, !felt.type
      constrain.eq %11, %12 : !felt.type, !felt.type
      constrain.eq %0, %arg1 : !felt.type, !felt.type
      %13 = struct.readm %arg0[@adv_2_6] : <@Main<[]>>, !felt.type
      constrain.eq %11, %13 : !felt.type, !felt.type
