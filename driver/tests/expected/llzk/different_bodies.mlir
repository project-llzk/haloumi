module attributes {llzk.lang = "haloumi"} {
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %15 = struct.readm %arg0[@adv_0_0] : <@Main<[]>>, !felt.type
      constrain.eq %15, %arg1 : !felt.type, !felt.type
      %16 = struct.readm %arg0[@adv_2_3] : <@Main<[]>>, !felt.type
      %17 = struct.readm %arg0[@adv_2_4] : <@Main<[]>>, !felt.type
      constrain.eq %16, %17 : !felt.type, !felt.type
      %18 = struct.readm %arg0[@adv_2_4] : <@Main<[]>>, !felt.type
      %19 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type
