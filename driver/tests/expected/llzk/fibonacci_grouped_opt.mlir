module attributes {llzk.lang = "haloumi"} {
  struct.def @fib {
    ...
    function.def @constrain(%arg0: !struct.type<@fib<[]>>, %arg1: !felt.type, %arg2: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %4 = struct.readm %arg0[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %1, %4 : !felt.type, !felt.type
      constrain.eq %arg2, %4 : !felt.type, !felt.type
      function.return
    }
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type {llzk.pub = #llzk.pub}, %arg2: !felt.type {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %3 = struct.readm %2[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %1, %3 : !felt.type, !felt.type
      %4 = struct.readm %arg0[@adv_2_1] : <@Main<[]>>, !felt.type
      %5 = struct.readm %2[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %4, %5 : !felt.type, !felt.type
      %6 = struct.readm %arg0[@fib_1] : <@Main<[]>>, !struct.type<@fib<[]>>
      function.call @fib::@constrain(%6, %1, %4) : (!struct.type<@fib<[]>>, !felt.type, !felt.type) -> ()
      %7 = struct.readm %6[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %4, %7 : !felt.type, !felt.type
      %8 = struct.readm %arg0[@adv_2_2] : <@Main<[]>>, !felt.type
      %9 = struct.readm %6[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %8, %9 : !felt.type, !felt.type
      %10 = struct.readm %arg0[@fib_2] : <@Main<[]>>, !struct.type<@fib<[]>>
      function.call @fib::@constrain(%10, %4, %8) : (!struct.type<@fib<[]>>, !felt.type, !felt.type) -> ()
      %11 = struct.readm %10[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %8, %11 : !felt.type, !felt.type
      %12 = struct.readm %arg0[@adv_2_3] : <@Main<[]>>, !felt.type
      %13 = struct.readm %10[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %12, %13 : !felt.type, !felt.type
      %14 = struct.readm %arg0[@fib_3] : <@Main<[]>>, !struct.type<@fib<[]>>
      function.call @fib::@constrain(%14, %8, %12) : (!struct.type<@fib<[]>>, !felt.type, !felt.type) -> ()
      %15 = struct.readm %14[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %12, %15 : !felt.type, !felt.type
      %16 = struct.readm %arg0[@adv_2_4] : <@Main<[]>>, !felt.type
      %17 = struct.readm %14[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %16, %17 : !felt.type, !felt.type
      %18 = struct.readm %arg0[@fib_4] : <@Main<[]>>, !struct.type<@fib<[]>>
      function.call @fib::@constrain(%18, %12, %16) : (!struct.type<@fib<[]>>, !felt.type, !felt.type) -> ()
      %19 = struct.readm %18[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %16, %19 : !felt.type, !felt.type
      %20 = struct.readm %arg0[@adv_2_5] : <@Main<[]>>, !felt.type
      %21 = struct.readm %18[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %20, %21 : !felt.type, !felt.type
      %22 = struct.readm %arg0[@fib_5] : <@Main<[]>>, !struct.type<@fib<[]>>
      function.call @fib::@constrain(%22, %16, %20) : (!struct.type<@fib<[]>>, !felt.type, !felt.type) -> ()
      %23 = struct.readm %22[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %20, %23 : !felt.type, !felt.type
      %24 = struct.readm %arg0[@adv_2_6] : <@Main<[]>>, !felt.type
      %25 = struct.readm %22[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %24, %25 : !felt.type, !felt.type
      %26 = struct.readm %arg0[@fib_6] : <@Main<[]>>, !struct.type<@fib<[]>>
      function.call @fib::@constrain(%26, %20, %24) : (!struct.type<@fib<[]>>, !felt.type, !felt.type) -> ()
      %27 = struct.readm %26[@out_0] : <@fib<[]>>, !felt.type
      constrain.eq %24, %27 : !felt.type, !felt.type
      %28 = struct.readm %arg0[@adv_2_7] : <@Main<[]>>, !felt.type
      %29 = struct.readm %26[@out_1] : <@fib<[]>>, !felt.type
      constrain.eq %28, %29 : !felt.type, !felt.type
      %30 = felt.add %0, %1 : !felt.type, !felt.type
      %31 = struct.readm %arg0[@adv_2_0] : <@Main<[]>>, !felt.type
      constrain.eq %30, %31 : !felt.type, !felt.type
      constrain.eq %0, %arg1 : !felt.type, !felt.type
      constrain.eq %1, %arg2 : !felt.type, !felt.type
      %32 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type
      constrain.eq %24, %32 : !felt.type, !felt.type
      %33 = struct.readm %arg0[@out_1] : <@Main<[]>>, !felt.type
      constrain.eq %28, %33 : !felt.type, !felt.type
      function.return
    }
