module attributes {llzk.fields = [#felt.field<"f", 21888242871839275222246405745257275088548364400416034343698204186575808495617>],llzk.lang = "haloumi"} {
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"f"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %felt_const_2 = felt.const  2 <"f">
      %13 = felt.neg %felt_const_2 : !felt.type<"f">
      %14 = felt.add %felt_const_21888242871839275222246405745257275088548364400416034343698204186575808495616_3, %13 : !felt.type<"f">, !felt.type<"f">
      %felt_const_3 = felt.const  3 <"f">
      %15 = felt.add %14, %felt_const_3 : !felt.type<"f">, !felt.type<"f">
      %16 = felt.mul %felt_const_1_2, %15 : !felt.type<"f">, !felt.type<"f">
      %felt_const_0_4 = felt.const  0 <"f">
      constrain.eq %16, %felt_const_0_4 : !felt.type<"f">, !felt.type<"f">
      %felt_const_2_5 = felt.const  2 <"f">
      %17 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"f">
      constrain.eq %felt_const_2_5, %17 : !felt.type<"f">, !felt.type<"f">
      %18 = struct.readm %arg0[@adv_0_0] : <@Main<[]>>, !felt.type<"f">
      constrain.eq %18, %arg1 : !felt.type<"f">, !felt.type<"f">
      %19 = struct.readm %arg0[@adv_2_0] : <@Main<[]>>, !felt.type<"f">
      %20 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type<"f">
      constrain.eq %19, %20 : !felt.type<"f">, !felt.type<"f">
      %felt_const_2_6 = felt.const  2 <"f">
      %felt_const_2_7 = felt.const  2 <"f">
      constrain.eq %felt_const_2_6, %felt_const_2_7 : !felt.type<"f">, !felt.type<"f">
      function.return
    }
