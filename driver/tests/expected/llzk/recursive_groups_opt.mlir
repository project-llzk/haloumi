module attributes {llzk.lang = "haloumi"} {
  struct.def @mul_many {
    ...
    function.def @constrain(%arg0: !struct.type<@mul_many<[]>>, %arg1: !felt.type, %arg2: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      constrain.eq %arg2, %1 : !felt.type, !felt.type
      function.return
    }
  ...
  struct.def @mul_many1 {
    ...
    function.def @constrain(%arg0: !struct.type<@mul_many1<[]>>, %arg1: !felt.type, %arg2: !felt.type, %arg3: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %2 = struct.readm %0[@out_0] : <@mul_many<[]>>, !felt.type
      constrain.eq %1, %2 : !felt.type, !felt.type
      %3 = struct.readm %arg0[@adv_0_5] : <@mul_many1<[]>>, !felt.type
      %4 = struct.readm %arg0[@adv_1_5] : <@mul_many1<[]>>, !felt.type
      %5 = felt.mul %3, %4 : !felt.type, !felt.type
      %6 = struct.readm %arg0[@out_0] : <@mul_many1<[]>>, !felt.type
  ...
  struct.def @mul_many2 {
    ...
    function.def @constrain(%arg0: !struct.type<@mul_many2<[]>>, %arg1: !felt.type, %arg2: !felt.type, %arg3: !felt.type, %arg4: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %2 = struct.readm %0[@out_0] : <@mul_many1<[]>>, !felt.type
      constrain.eq %1, %2 : !felt.type, !felt.type
      %3 = struct.readm %arg0[@adv_0_6] : <@mul_many2<[]>>, !felt.type
      %4 = struct.readm %arg0[@adv_1_6] : <@mul_many2<[]>>, !felt.type
      %5 = felt.mul %3, %4 : !felt.type, !felt.type
      %6 = struct.readm %arg0[@out_0] : <@mul_many2<[]>>, !felt.type
      constrain.eq %5, %6 : !felt.type, !felt.type
      constrain.eq %arg1, %3 : !felt.type, !felt.type
      constrain.eq %1, %4 : !felt.type, !felt.type
      function.return
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type {llzk.pub = #llzk.pub}, %arg2: !felt.type {llzk.pub = #llzk.pub}, %arg3: !felt.type {llzk.pub = #llzk.pub}, %arg4: !felt.type {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
      ...
      %6 = struct.readm %4[@out_0] : <@mul_many2<[]>>, !felt.type
      constrain.eq %5, %6 : !felt.type, !felt.type
      constrain.eq %0, %arg1 : !felt.type, !felt.type
      constrain.eq %1, %arg2 : !felt.type, !felt.type
      constrain.eq %2, %arg3 : !felt.type, !felt.type
      constrain.eq %3, %arg4 : !felt.type, !felt.type
      %7 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type
