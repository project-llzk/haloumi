...
use haloumi::ir_gen::IRGenParams;
use haloumi_test_circuits::mul;
...
basic_picus_test! {
    ...
    IRGenParams::new().gate_callbacks(&common::GC)
}
...
mod mul_inject {
    ...
    use haloumi::{
        driver::Driver,
        ir_gen::{IRGenParams, circuit::resolved::ResolvedIRCircuit, expressions::ExpressionInRow},
