module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>>     } {
  struct.def @"test group" {
    ...
    function.def @constrain(%arg0: !struct.type<@"test group"<[]>>, %arg1: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %13 = struct.readm %arg0[@adv_0_0] : <@"test group"<[]>>, !felt.type<"bn254">
  ...
  struct.def @"test group1" {
    ...
    function.def @constrain(%arg0: !struct.type<@"test group1"<[]>>, %arg1: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      %felt_const_1 = felt.const  1 <"bn254">
      %0 = struct.readm %arg0[@adv_0_2] : <@"test group1"<[]>>, !felt.type<"bn254">
      %1 = struct.readm %arg0[@adv_1_2] : <@"test group1"<[]>>, !felt.type<"bn254">
      ...
      %7 = struct.readm %arg0[@adv_0_2] : <@"test group1"<[]>>, !felt.type<"bn254">
  ...
  struct.def @"inner group" {
    ...
    function.def @constrain(%arg0: !struct.type<@"inner group"<[]>>, %arg1: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      %felt_const_1 = felt.const  1 <"bn254">
      %0 = struct.readm %arg0[@adv_0_3] : <@"inner group"<[]>>, !felt.type<"bn254">
      %1 = struct.readm %arg0[@adv_1_3] : <@"inner group"<[]>>, !felt.type<"bn254">
      %2 = felt.mul %0, %1 : !felt.type<"bn254">, !felt.type<"bn254">
      ...
      %felt_const_0 = felt.const  0 <"bn254">
      constrain.eq %6, %felt_const_0 : !felt.type<"bn254">, !felt.type<"bn254">
      %7 = struct.readm %arg0[@adv_0_3] : <@"inner group"<[]>>, !felt.type<"bn254">
      constrain.eq %arg1, %7 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
  ...
  struct.def @"outer group" {
    struct.member @out_0 : !felt.type<"bn254"> {llzk.pub}
    struct.member @"subgrp_inner group_0" : !struct.type<@"inner group"<[]>>
    ...
    function.def @constrain(%arg0: !struct.type<@"outer group"<[]>>, %arg1: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      %0 = struct.readm %arg0[@"subgrp_inner group_0"] : <@"outer group"<[]>>, !struct.type<@"inner group"<[]>>
      function.call @"inner group"::@constrain(%0, %arg1) : (!struct.type<@"inner group"<[]>>, !felt.type<"bn254">) -> ()
      %1 = struct.readm %arg0[@adv_2_3] : <@"outer group"<[]>>, !felt.type<"bn254">
      %2 = struct.readm %arg0[@"subgrp_inner group_0"] : <@"outer group"<[]>>, !struct.type<@"inner group"<[]>>
      %3 = struct.readm %2[@out_0] : <@"inner group"<[]>>, !felt.type<"bn254">
      constrain.eq %1, %3 : !felt.type<"bn254">, !felt.type<"bn254">
      %felt_const_1 = felt.const  1 <"bn254">
      %felt_const_21888242871839275222246405745257275088548364400416034343698204186575808495616 = felt.const  21888242871839275222246405745257275088548364400416034343698204186575808495616 <"bn254">
      %4 = struct.readm %arg0[@adv_0_4] : <@"outer group"<[]>>, !felt.type<"bn254">
      ...
      %6 = struct.readm %arg0[@adv_1_4] : <@"outer group"<[]>>, !felt.type<"bn254">
      ...
      %felt_const_1_0 = felt.const  1 <"bn254">
      %10 = struct.readm %arg0[@adv_0_4] : <@"outer group"<[]>>, !felt.type<"bn254">
      %11 = struct.readm %arg0[@adv_1_4] : <@"outer group"<[]>>, !felt.type<"bn254">
      ...
      %17 = struct.readm %arg0[@adv_2_3] : <@"outer group"<[]>>, !felt.type<"bn254">
      %18 = struct.readm %arg0[@adv_0_4] : <@"outer group"<[]>>, !felt.type<"bn254">
  ...
  struct.def @Main {
    ...
    struct.member @"subgrp_test group1_2" : !struct.type<@"test group1"<[]>>
    struct.member @"subgrp_outer group_3" : !struct.type<@"outer group"<[]>>
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %2 = struct.readm %arg0[@adv_2_0] : <@Main<[]>>, !felt.type<"bn254">
      ...
      %5 = struct.readm %arg0[@adv_2_0] : <@Main<[]>>, !felt.type<"bn254">
      ...
      %11 = struct.readm %arg0[@"subgrp_test group1_2"] : <@Main<[]>>, !struct.type<@"test group1"<[]>>
      function.call @"test group1"::@constrain(%11, %10) : (!struct.type<@"test group1"<[]>>, !felt.type<"bn254">) -> ()
      %12 = struct.readm %arg0[@adv_2_2] : <@Main<[]>>, !felt.type<"bn254">
      %13 = struct.readm %arg0[@"subgrp_test group1_2"] : <@Main<[]>>, !struct.type<@"test group1"<[]>>
      ...
      %16 = struct.readm %arg0[@"subgrp_outer group_3"] : <@Main<[]>>, !struct.type<@"outer group"<[]>>
      function.call @"outer group"::@constrain(%16, %15) : (!struct.type<@"outer group"<[]>>, !felt.type<"bn254">) -> ()
      %17 = struct.readm %arg0[@adv_2_4] : <@Main<[]>>, !felt.type<"bn254">
      %18 = struct.readm %arg0[@"subgrp_outer group_3"] : <@Main<[]>>, !struct.type<@"outer group"<[]>>
      %19 = struct.readm %18[@out_0] : <@"outer group"<[]>>, !felt.type<"bn254">
      constrain.eq %17, %19 : !felt.type<"bn254">, !felt.type<"bn254">
      %20 = struct.readm %arg0[@adv_2_4] : <@Main<[]>>, !felt.type<"bn254">
      %21 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %20, %21 : !felt.type<"bn254">, !felt.type<"bn254">
      %22 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %22, %arg1 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
