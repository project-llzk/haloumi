module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  ...
  struct.def @"outer group" {
    ...
    function.def @constrain(%arg0: !struct.type<@"outer group"<[]>>, %arg1: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      constrain.eq %1, %2 : !felt.type<"bn254">, !felt.type<"bn254">
      %3 = struct.readm %arg0[@adv_0_4] : <@"outer group"<[]>>, !felt.type<"bn254">
      %4 = felt.neg %3 : !felt.type<"bn254">
      %5 = struct.readm %arg0[@adv_1_4] : <@"outer group"<[]>>, !felt.type<"bn254">
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      constrain.eq %2, %3 : !felt.type<"bn254">, !felt.type<"bn254">
      %4 = struct.readm %arg0[@"subgrp_test group_1"] : <@Main<[]>>, !struct.type<@"test group"<[]>>
      ...
      %7 = struct.readm %arg0[@"subgrp_test group1_2"] : <@Main<[]>>, !struct.type<@"test group1"<[]>>
      ...
      %10 = struct.readm %arg0[@"subgrp_outer group_3"] : <@Main<[]>>, !struct.type<@"outer group"<[]>>
      function.call @"outer group"::@constrain(%10, %8) : (!struct.type<@"outer group"<[]>>, !felt.type<"bn254">) -> ()
      %11 = struct.readm %arg0[@adv_2_4] : <@Main<[]>>, !felt.type<"bn254">
