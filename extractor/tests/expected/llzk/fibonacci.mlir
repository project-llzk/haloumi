module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}, %arg2: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %bis56 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %56, %bis56 : !felt.type<"bn254">, !felt.type<"bn254">
      %57 = struct.readm %arg0[@adv_0_1] : <@Main<[]>>, !felt.type<"bn254">
      %58 = struct.readm %arg0[@adv_3_1] : <@Main<[]>>, !felt.type<"bn254">
      ...
      %bis71 = struct.readm %arg0[@adv_3_1] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %71, %bis71 : !felt.type<"bn254">, !felt.type<"bn254">
      ...
      %90 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %90, %arg1 : !felt.type<"bn254">, !felt.type<"bn254">
      %91 = struct.readm %arg0[@adv_3_1] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %91, %arg2 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
