module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}, %arg2: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %6 = struct.readm %arg0[@"subgrp_fib_1"] : <@Main<[]>>, !struct.type<@fib<[]>>
      ...
      %8 = struct.readm %arg0[@adv_2_1] : <@Main<[]>>, !felt.type<"bn254">
      %9 = struct.readm %6[@out_1] : <@fib<[]>>, !felt.type<"bn254">
      constrain.eq %8, %9 : !felt.type<"bn254">, !felt.type<"bn254">
      %10 = struct.readm %arg0[@"subgrp_fib_2"] : <@Main<[]>>, !struct.type<@fib<[]>>
      ...
      %14 = struct.readm %arg0[@"subgrp_fib_3"] : <@Main<[]>>, !struct.type<@fib<[]>>
      ...
      %16 = struct.readm %arg0[@adv_2_3] : <@Main<[]>>, !felt.type<"bn254">
      %17 = struct.readm %14[@out_1] : <@fib<[]>>, !felt.type<"bn254">
      constrain.eq %16, %17 : !felt.type<"bn254">, !felt.type<"bn254">
      %18 = struct.readm %arg0[@"subgrp_fib_4"] : <@Main<[]>>, !struct.type<@fib<[]>>
      ...
      %22 = struct.readm %arg0[@"subgrp_fib_5"] : <@Main<[]>>, !struct.type<@fib<[]>>
      ...
      %24 = struct.readm %arg0[@adv_2_5] : <@Main<[]>>, !felt.type<"bn254">
      %25 = struct.readm %22[@out_1] : <@fib<[]>>, !felt.type<"bn254">
      constrain.eq %24, %25 : !felt.type<"bn254">, !felt.type<"bn254">
      %26 = struct.readm %arg0[@"subgrp_fib_6"] : <@Main<[]>>, !struct.type<@fib<[]>>
      ...
      %28 = struct.readm %arg0[@adv_2_6] : <@Main<[]>>, !felt.type<"bn254">
