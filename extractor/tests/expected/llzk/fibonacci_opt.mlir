module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}, %arg2: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %bis31 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %0, %bis31 : !felt.type<"bn254">, !felt.type<"bn254">
      %bis31_2 = struct.readm %arg0[@adv_3_1] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %4, %bis31_2 : !felt.type<"bn254">, !felt.type<"bn254">
      ...
      constrain.eq %1, %bis31_2 : !felt.type<"bn254">, !felt.type<"bn254">
      ...
      constrain.eq %bis31, %arg1 : !felt.type<"bn254">, !felt.type<"bn254">
      constrain.eq %bis31_2, %arg2 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
