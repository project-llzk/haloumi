module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %7 = struct.readm %arg0[@adv_0_0] : <@Main<[]>>, !felt.type<"bn254">
      %8 = struct.readm %arg0[@adv_2_0] : <@Main<[]>>, !felt.type<"bn254">
      %9 = felt.mul %7, %8 : !felt.type<"bn254">, !felt.type<"bn254">
      ...
      %14 = struct.readm %arg0[@adv_0_0] : <@Main<[]>>, !felt.type<"bn254">
      %15 = struct.readm %arg0[@adv_4_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %14, %15 : !felt.type<"bn254">, !felt.type<"bn254">
      %16 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"bn254">
      %17 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %16, %17 : !felt.type<"bn254">, !felt.type<"bn254">
      %18 = struct.readm %arg0[@adv_4_0] : <@Main<[]>>, !felt.type<"bn254">
    ...
    struct.member @adv_4_0 : !felt.type<"bn254">
  }
}
