module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %1 = struct.readm %arg0[@adv_4_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %0, %1 : !felt.type<"bn254">, !felt.type<"bn254">
      %2 = struct.readm %arg0[@adv_3_0] : <@Main<[]>>, !felt.type<"bn254">
      %3 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %2, %3 : !felt.type<"bn254">, !felt.type<"bn254">
      %4 = struct.readm %arg0[@adv_4_0] : <@Main<[]>>, !felt.type<"bn254">
      constrain.eq %4, %arg1 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
