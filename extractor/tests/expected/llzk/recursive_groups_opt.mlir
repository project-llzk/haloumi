module attributes { llzk.lang = "halo2", llzk.main = !struct.type<@Main<[]>> } {
  struct.def @mul_many {
    ...
    function.def @constrain(%arg0: !struct.type<@mul_many<[]>>, %arg1: !felt.type<"bn254">, %arg2: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      constrain.eq %arg2, %1 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
  ...
  struct.def @mul_many1 {
    ...
    function.def @constrain(%arg0: !struct.type<@mul_many1<[]>>, %arg1: !felt.type<"bn254">, %arg2: !felt.type<"bn254">, %arg3: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %2 = struct.readm %0[@out_0] : <@mul_many<[]>>, !felt.type<"bn254">
      constrain.eq %1, %2 : !felt.type<"bn254">, !felt.type<"bn254">
      %3 = struct.readm %arg0[@adv_0_1] : <@mul_many1<[]>>, !felt.type<"bn254">
      %4 = struct.readm %arg0[@adv_1_1] : <@mul_many1<[]>>, !felt.type<"bn254">
      %5 = felt.mul %3, %4 : !felt.type<"bn254">, !felt.type<"bn254">
      %6 = struct.readm %arg0[@out_0] : <@mul_many1<[]>>, !felt.type<"bn254">
      constrain.eq %5, %6 : !felt.type<"bn254">, !felt.type<"bn254">
      constrain.eq %1, %4 : !felt.type<"bn254">, !felt.type<"bn254">
      constrain.eq %arg1, %3 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
  ...
  struct.def @mul_many2 {
    ...
    function.def @constrain(%arg0: !struct.type<@mul_many2<[]>>, %arg1: !felt.type<"bn254">, %arg2: !felt.type<"bn254">, %arg3: !felt.type<"bn254">, %arg4: !felt.type<"bn254">) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %2 = struct.readm %0[@out_0] : <@mul_many1<[]>>, !felt.type<"bn254">
      constrain.eq %1, %2 : !felt.type<"bn254">, !felt.type<"bn254">
      %3 = struct.readm %arg0[@adv_0_2] : <@mul_many2<[]>>, !felt.type<"bn254">
      %4 = struct.readm %arg0[@adv_1_2] : <@mul_many2<[]>>, !felt.type<"bn254">
      %5 = felt.mul %3, %4 : !felt.type<"bn254">, !felt.type<"bn254">
      %6 = struct.readm %arg0[@out_0] : <@mul_many2<[]>>, !felt.type<"bn254">
      constrain.eq %5, %6 : !felt.type<"bn254">, !felt.type<"bn254">
      constrain.eq %1, %4 : !felt.type<"bn254">, !felt.type<"bn254">
      constrain.eq %arg1, %3 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
  ...
  struct.def @Main {
    ...
    function.def @constrain(%arg0: !struct.type<@Main<[]>>, %arg1: !felt.type<"bn254"> {llzk.pub = #llzk.pub}, %arg2: !felt.type<"bn254"> {llzk.pub = #llzk.pub}, %arg3: !felt.type<"bn254"> {llzk.pub = #llzk.pub}, %arg4: !felt.type<"bn254"> {llzk.pub = #llzk.pub}) attributes {function.allow_constraint, function.allow_non_native_field_ops, function.allow_verif_ops} {
      ...
      %6 = struct.readm %4[@out_0] : <@mul_many2<[]>>, !felt.type<"bn254">
      constrain.eq %5, %6 : !felt.type<"bn254">, !felt.type<"bn254">
      %7 = struct.readm %arg0[@out_0] : <@Main<[]>>, !felt.type<"bn254">
      ...
      constrain.eq %2, %arg3 : !felt.type<"bn254">, !felt.type<"bn254">
      constrain.eq %3, %arg4 : !felt.type<"bn254">, !felt.type<"bn254">
      function.return
    }
