...
mod helper_traits {
    ...
    pub trait ColumnConversion<Dst: haloumi_core::table::ColumnType>: Sized {
        fn convert(&self) -> Dst;
    }
    ...
    impl RotationExt for haloumi_core::table::Rotation {
        fn to_halo2(self) -> Rotation {
            Rotation(self)
        }
    }
...
impl ColumnConversion<haloumi_core::query::Advice> for _Advice {
    fn convert(&self) -> haloumi_core::query::Advice {
        haloumi_core::query::Advice
    }
}
...
impl ColumnConversion<haloumi_core::table::Any> for _Any {
    fn convert(&self) -> haloumi_core::table::Any {
        match self.0 {
            Any::Advice(_) => haloumi_core::table::Any::Advice,
            Any::Fixed => haloumi_core::table::Any::Fixed,
            Any::Instance => haloumi_core::table::Any::Instance,
        }
    }
}
...
impl<FC: ColumnWrapper + ColumnConversion<TC>, TC: haloumi_core::table::ColumnType>
    From<_Column<FC>> for haloumi_core::table::Column<TC>
{
...
impl ColumnConversion<haloumi_core::query::Fixed> for _Fixed {
    fn convert(&self) -> haloumi_core::query::Fixed {
        haloumi_core::query::Fixed
    }
}
...
impl ColumnConversion<haloumi_core::query::Instance> for _Instance {
    fn convert(&self) -> haloumi_core::query::Instance {
        haloumi_core::query::Instance
    }
}
